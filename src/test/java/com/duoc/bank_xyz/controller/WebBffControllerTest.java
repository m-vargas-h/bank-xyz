...
import com.duoc.bank_xyz.config.SecurityConfig;
...
@WebMvcTest(WebBffController.class)
...
class WebBffControllerTest {
    ...
    void getCuentaById_noExiste_retorna404() throws Exception {
        ...
        mockMvc.perform(get("/web/cuentas/9999"))
    ...
    void getTransacciones_conRolIncorrecto_retorna403() throws Exception {
        mockMvc.perform(get("/web/transacciones"))
